const About = () => {
    return (
        ...
        <div className="container-right">
            <div id="about">
                <h1>About</h1>
                <p>I'm a passionate Software Developer with a creative mindset, based in Sydney.<br /> 
                My dedication to coding brought me to undertake a web development bootcamp - <a href="https://www.lewagon.com/" target="_blank" rel="noreferrer"><nobr>Le Wagon Melbourne</nobr></a>.<br />
                ...
                I'm passionnate, value my strong work ethic, promote Fair go and am environmentally conscious. In addition, I'm constantly looking for growth and learning opportunities.</p>
            </div>
        </div>
        </>
    )
